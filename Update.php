...
<head>
    ...
    <title>YETRADING | تعديل منتج</title>
...
$ID = $_GET['id'];
$UP = mysqli_query($conn, "SELECT * FROM tb_product WHERE id='$ID'");
...
<center>
    ...
    <h3 class = "title">تعديل منتج</h3>

    <form action="Up.php" method="POST" enctype="multipart/form-data">

    <div class="input-field input-0" style="display: none;" >
    <img src="Icon/products_new_cube_product_design_icon_153845.png" class="Search_img">
        <input type="text" name = "id" required="required" value="<?php echo $DATA['id']?>">
    </div>

    <div class="input-field input-1">
    <img src="Icon/products_new_cube_product_design_icon_153845.png" class="Search_img">
        <input type="text" name = "name" placeholder = "ادخل اسم المنتج" required="required" value="<?php echo $DATA['name']?>" >
    </div>
    ...
    <div class="cover_lb">
    <label for="file" class = "lb_add_img"><img src="Icon/image-add-button_icon-icons.com_71462.png" class="Search_img">تحديث صورة</label>
    </div>

    <br>   
    <br>

    <button name = "update" class = "btn_add">تعديل المنتج</button>
